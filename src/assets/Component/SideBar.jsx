...
const SideBar = ({toggle}) => {
    ...
    console.log(data)
  return (
    <div className={` md:w-1/3 ${toggle?'-translate-x-0':'translate-x-[100%]'}  duration-500 right-0   w-full fixed top-0 bg-blue-500 min-h-screen h-auto  z-20 bg-purple-500`}>
     <div>
